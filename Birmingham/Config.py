...
colListNeeded = ['LoS', 'CORSubRegion', 'FirstStudentStatus', 'EnrolledNumeric', 'CourseGroup', 'InitialOfferMonth', 'InitialOfferDay', 'TagValueGroup']

#REST endpoint
url = 'http://4dcbaca7-2d17-44a8-ad52-41a1de98a525.australiaeast.azurecontainer.io/score'
